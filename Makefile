...
clean:
	...
	rm -rf v8_handles_paper.aux v8_handles_paper.bbl v8_handles_paper.blg v8_handles_paper.dvi v8_handles_paper.log v8_handles_paper.ps v8_handles_paper.pdf v8_handles_paper.toc v8_handles_paper.out v8_handles_paper.snm v8_handles_paper.nav v8_handles_paper.vrb texput.log v8_handles_paper_preamble.fmt
